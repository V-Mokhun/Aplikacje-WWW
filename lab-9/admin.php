...
/**
 * Processes all form submissions and actions in the admin panel
 * Handles page updates, additions, deletions, and logout
 * 
...
function ListaPodstron($link) {
    ...
    while ($row = mysqli_fetch_array($pages)) {
        $result .= '<tr>
                    ...
                    <td>
                        <a href="?action=edit&id='.htmlspecialchars($row['id']).'">Edytuj</a>
...
function EdytujPodstrone($link) {
    ...
    if ($id === false) {
        return '<div class="error">Nieprawidłowe ID strony</div>';
    }
