            ...
            try {
                ...
                if (empty($errors)) {
                    ...
                    if (empty($errors)) {
                        ...
                        $params = [$title, $description, $net_price, $vat_rate,
                                $stock_quantity, $category_id, $dimensions,
                                $expiry_date, $availability_status];
                        $types = "ssddiiiss";
        ...
        try {
            ...
            if (empty($errors)) {
                ...
                if (empty($errors)) {
                    ...
                    $stmt = mysqli_prepare($link, $query);
                    mysqli_stmt_bind_param($stmt, "ssddiiissss",
                        $title, $description, $net_price, $vat_rate, $stock_quantity,
                        $category_id, $dimensions, $expiry_date, $availability_status,
